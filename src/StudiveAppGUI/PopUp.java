...
public class PopUp {
    ...
    public PopUp(PApplet p5, float x, float y, float w, float h){
        ...
        this.b1 = new Button(p5, "Opcio 1", x + m, y +h - buttonH*3.5f, 300, 70);
        this.b2 = new Button(p5, "Opcio2", x + m, y + h - buttonH*2.5f, 300, 70);
        this.b3 = new Button(p5, "Opcio3", x + m, y + h -buttonH*1.5f, 300, 70);
    }
